...
1. [1.文件描述符?每个描述符的含义?](#1)
2. [2.什么是环境变量？](#2)
3. [3.账户默认信息？添加账户？删除用户？](#3)
4. [4.lvs/nginx/haproxy优缺点](#4)
5. [5.Windows和Linux的区别](#5)
6. [6.启动shell](#6)
7. [7.netstat 命令](#7)
8. [8.修改权限?](#8)
9. [9.LVS、Nginx、HAproxy有什么区别？工作中你怎么选择？](#9)
10. [10.如何切换目录？](#10)
11. [11.每天晚上 12 点，打包站点目录/var/www/html 备份到/data目录下](#)
12. [12如何将本地80 端口的请求转发到8080端口，当前主机IP为192.168.2.1](#)
13. [13说说TCP/IP的七层模型](#)
14. [14如何查看命令历史记录?](#)
15. [15请执行命令取出 linux 中 eth0 的 IP 地址](#)
16. [16如何查找匹配的文件？基于文件属性？](#)
17. [17Ls 命令执行什么功能？ 可以带哪些参数，有什么区别？](#)
18. [18如何中断一个进程?](#)
19. [19怎么查看系统支持的所有信号？](#)
20. [20如何用sed只打印第5行?删除第一行？替换字符串?](#)
21. [21Linux 的目录结构是怎样的？](#)
22. [22请列出你了解的web服务器负载架构](#)
23. [23建立软链接(快捷方式)，以及硬链接的命令。](#)
24. [24交互方式](#)
25. [25讲述一下Tomcat8005、8009、8080三个端口的含义？](#)
26. [26Tomcat和Resin有什么区别，工作中你怎么选择？](#)
27. [27find （find：找到的意思）查找指定文件或目录](#)
28. [28怎样一页一页地查看一个大文件的内容呢？](#)
29. [29mkdir （mkdir：创建目录） 创建目录](#)


## <span id="1">1、文件描述符?每个描述符的含义?</span>
...
## <span id="3">3、账户默认信息？添加账户？删除用户？</span>
...
## <span id="4">4、lvs/nginx/haproxy优缺点</span>
...
## <span id="5">5、Windows和Linux的区别</span>
...
## <span id="9">9、LVS、Nginx、HAproxy有什么区别？工作中你怎么选择？</span>
